...
@MicronautTest
@Property(name = "eclipsestore.postgres.storage.foo.datasource-name", value = "other")
@Property(name = "eclipsestore.postgres.storage.foo.table-name", value = NamedPostgresStorageSpec.TABLE_NAME)
