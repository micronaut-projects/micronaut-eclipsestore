...
@Property(name = "eclipsestore.s3.storage.foo.s3-client-name", value = NamedS3StorageSpec.OTHER_CLIENT_NAME)
@Property(name = "eclipsestore.s3.storage.foo.bucket-name", value = NamedS3StorageSpec.BUCKET_NAME)
@Property(name = "eclipsestore.s3.storage.foo.root-class", value = 'io.micronaut.eclipsestore.BaseStorageSpec$Root')
